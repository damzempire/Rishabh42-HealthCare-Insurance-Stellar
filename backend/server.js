...
const premiumAdjustmentRoutes = require('./routes/premiumAdjustments');
...
app.use('/api/premium-adjustments', authenticateToken, cacheMiddleware, premiumAdjustmentRoutes);
